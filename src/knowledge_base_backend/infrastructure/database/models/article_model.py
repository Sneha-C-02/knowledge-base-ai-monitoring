...
class ArticleModel(Base):
    ...
    # We map search_vector as deferred or exclude it, it's auto-generated in PG
    
    # Assume vector column exists via vector extension
    # article_embedding = Column(Vector(EMBEDDING_DIMENSION))
